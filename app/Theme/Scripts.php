...
class Scripts implements \Dxw\Iguana\Registerable
{
    ...
    public function register()
    {
        ...
        add_action('login_enqueue_scripts', function () {
            wp_enqueue_style('wp-admin2', $this->getAssetPath('wp-admin.min.css'));
        });
    }
    ...
    public function wpPrintScripts()
    {
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?php $this->assetPath('img/favicon.ico') ?>">
        <link rel="shortcut icon" href="<?php $this->assetPath('img/touch-icon.png') ?>">
        <link rel="apple-touch-icon-precomposed" href="<?php $this->assetPath('img/touch-icon.png') ?>">
        <?php
