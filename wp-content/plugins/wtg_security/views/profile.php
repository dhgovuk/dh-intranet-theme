	...
	<p>Use this screen to update your personal information and the news you have subscribed for. Remember, when you’ve
     ...
     <ul>
         <li>
           ...
           value="<?php echo $_POST ? $_POST['first_name'] : esc_attr( $profileuser->first_name ); ?>"
           class="regular-text" />
       </li>
       ...
       value="<?php echo $_POST ? $_POST['last_name'] : esc_attr( $profileuser->last_name ); ?>"
       class="regular-text" />
   </li>
   <li>
...
<?php if (is_ip_whitelisted()) : ?>
 <li>
    ...
    value="<?php echo the_author_meta('home_email', $profileuser->ID); ?>"
...
<?php else:  ?>
    <input type="hidden" name="home_email"
    value="<?php echo the_author_meta('home_email', $profileuser->ID); ?>" />
<?php endif; ?>
<?php foreach ( _wp_get_user_contactmethods() as $name => $desc ) : ?>
    <li>
       ...
       value="<?php echo esc_atli( $profileuser->$name ); ?>" class="regular-text" />
   </li>
<?php endforeach; ?>
<li>
...
<fieldset class="subscriptions">
 ...
 <p>You'll receive news and updated guidance on areas of your interest once a week.  You can opt in or out
    ...
    <div class="newsletter-categories">
        ...
        <?php endif ?>
        <li>
            <input type="checkbox" name="newsletter_cats[<?php echo $cat->term_id?>]"
            id="sub_<?php echo $cat->term_id ?>" value="<?php echo $cat->name ?>"
            ...
            <label for="sub_<?php echo $cat->term_id ?>"><?php echo $cat->name ?></label>
        </li>
    <?php endforeach; ?>
</ul>
</div>
