    ...
    public static function display_all_statuses()
    {
        ...
        if (isset($status_data['statuses']) && is_array($status_data['statuses'])) {
            foreach ($status_data['statuses'] as $status) {
                ...
                <img class=\"status_circle\" src=\"/wp-content/themes/dh-intranet/assets/img/status-light-$status[status].png\">
                </td>";
                $output .= '</tr>';
            }
        }
        ...
        $output .= "<td class='it-status-table-light'>
        <img class=\"status-circle\" src=\"/wp-content/themes/dh-intranet/assets/img/status-light-{$status_data['overall_status']['status']}.png\"></td>";
        $output .= '</tr>';
